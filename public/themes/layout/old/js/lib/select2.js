...
;(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['public/themes/layout/old/js/lib/jquery'], factory);
    ...
    module.exports = function (root, jQuery) {
      if (jQuery === undefined) {
        ...
        if (typeof window !== 'undefined') {
          jQuery = require('public/themes/layout/old/js/lib/jquery');
        }
        else {
          jQuery = require('public/themes/layout/old/js/lib/jquery')(root);
        }
      }
      factory(jQuery);
      return jQuery;
